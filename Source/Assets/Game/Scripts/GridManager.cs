...
public class GridManager : MonoBehaviour
{
        ...
        // of the GameStart animation.
    {
        ...
        GameObject referencerYellowTile = (GameObject) Instantiate(Resources.Load("YellowTile"));
        for (int row = 0; row < _rows; row++)
        {
            for (int col = 0; col < _cols; col++)
            {
                ...
                {
                    tile = Instantiate(referencerYellowTile, transform);
                    tile.tag = "MiddleTile";
                }
                else
                {
